...
public class Ad_Incoming_Video_Callls extends Admin_BaseClass {
	@Test
	public void tc1_Incoming_Video_Call_History() throws IOException, InterruptedException {
		...
		WebElement View_All = driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[1]/div[4]/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/button[1]"));
		View_All.click();
		...
		String exp_Title = "Incoming Video Calls";
		WebElement Title = driver.findElement(By.xpath("//h3[normalize-space()='Incoming Video Calls']" ));
	...
	@Test
	public void tc2_Incoming_Video_Todays_Call() throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	@Test
	public void tc3_Filter_completed() throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	@Test
	public void tc4_Filter_rejected() throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	@Test
	public void tc9_Incoming_Video_Todays_Call() throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		...
		js.executeScript("window.scrollBy(0,document.body.scrollHeight)");
		Thread.sleep(1000);
		WebElement View_All = driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[1]/div[4]/div[1]/div[2]/div[4]/div[1]/div[1]/div[2]/button[1]"));
		View_All.click();
