...
public class Ad_Scheduled_Video_Calls extends Admin_BaseClass {
	@Test
	public void tc1_Schedule_Video_Call_History() throws IOException, InterruptedException {
		...
		WebElement View_All = driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[1]/div[4]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/button[1]"));
		View_All.click();
		
		Thread.sleep(1000);
		js.executeScript("window.scrollBy(0,document.body.scrollHeight)");
		Thread.sleep(1000);
		String exp_Title = "Scheduled Video Calls";
		WebElement Title = driver.findElement(By.xpath("//h3[normalize-space()='Scheduled Video Calls']" ));
	...
	@Test
	public void tc2_Schedule_Video_Todays_Call() throws IOException, InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
