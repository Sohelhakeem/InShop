...
public class Ad_Avatar_Profile extends Admin_BaseClass {
	@Test 
	...
	public void tc6_My_Profile_Country() throws IOException, InterruptedException{
		...
		WebElement  state_drp = (driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[4]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[7]/div[1]/div[1]/div[1]/div[1]")));
		state_drp.click();
		Thread.sleep(1000);
		WebElement  Telangana = (driver.findElement(By.xpath("(//li[normalize-space()='Telangana'])[1]")));
		Telangana.click();
	...
	public void tc9_Delete_Avatar() throws IOException, InterruptedException, AWTException{
		...
		WebElement Delete_Avatar= driver.findElement(By.xpath("//div[@class='flexInline PrflDeleteCntr justifyCntr alignCntr']"));
		Delete_Avatar.click();
